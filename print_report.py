...
def generate_report(truck_one_total_distance, truck_two_total_distance, truck_three_total_distance, truck_time):
    ...
    print("*" * 40)
    print(f"truck one total distance traveled: {truck_one_total_distance} miles")
    print(f"truck two total distance traveled: {truck_two_total_distance} miles")
    print(f"truck three total distance traveled: {truck_three_total_distance} miles")
    print("*" * 40)
